package cn.sinoits.traffic.project.page.view;
...
public class MyBottomViewBar extends AppBarLayout.ScrollingViewBehavior {
    ...
    public MyBottomViewBar(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
